      ...
      <div class="login-form">
        ...
        <form name="mepr_loginform" id="mepr_loginform" class="mepr-form" action="<?php echo $login_url; ?>" method="post">
          ...
          <div class="remember-me">
            <label><input name="rememberme" type="checkbox" id="rememberme" value="forever" <?php checked(isset($_REQUEST['rememberme'])); ?> /> <span><?php _ex('Remember Me', 'ui', 'memberpress'); ?></span></label>
          </div>
