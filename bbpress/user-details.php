...
<div id="bbp-single-user-details">
  ...
  <div id="bbp-user-navigation">
    <ul>
      ...
      <li class="hidden <?php if (bbp_is_single_user_topics()) : ?>current<?php endif; ?>">
      ...
      <li class="hidden <?php if (bbp_is_single_user_replies()) : ?>current<?php endif; ?>">
      ...
      <?php if (bbp_is_engagements_active()) : ?>
        <li class="hidden <?php if (bbp_is_single_user_engagements()) : ?>current<?php endif; ?>">
      ...
      <?php if (bbp_is_favorites_active()) : ?>
        <li class="hidden <?php if (bbp_is_favorites()) : ?>current<?php endif; ?>">
      ...
      <?php if (bbp_is_user_home() || current_user_can('edit_user', bbp_get_displayed_user_id())) : ?>
        ...
        <?php if (bbp_is_subscriptions_active()) : ?>
          <li class="hidden <?php if (bbp_is_subscriptions()) : ?>current<?php endif; ?>">
