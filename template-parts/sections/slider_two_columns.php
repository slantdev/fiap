        ...
        <div class="slider-buttons absolute top-1/3 md:top-[40%] -translate-y-full -mt-4 lg:translate-y-0 lg:mt-0 lg:top-auto lg:bottom-10 left-0 right-0 z-10">
          <div class="container mx-auto">
            <div class="w-full lg:w-1/2 flex justify-end gap-x-2 lg:gap-x-4 lg:pr-16">
              <button type="button" class="slider--button-prev w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-fiap-darkblue text-gray-500 hover:text-white transition-all duration-200">
              ...
              <button type="button" class="slider--button-next w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-fiap-darkblue text-gray-500 hover:text-white transition-all duration-200">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
