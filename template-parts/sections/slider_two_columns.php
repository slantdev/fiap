    ...
    if (is_admin()) { ?>
      <div class="relative overflow-hidden">
        <div class="h-full w-full flex bg-fiap-teal">
          <div class="w-full relative bg-fiap-teal h-[700px] overflow-hidden">
            <div class="absolute inset-0">
              <div class="flex h-full">
                <div class="w-1/2 ml-auto"><img class="object-cover h-full w-full" src="<?php echo $slider_repeater[0]['image']['url'] ?>"></div>
              </div>
            </div>
              ...
              <div class="flex items-center h-full">
                <div class="w-1/2 pr-16 pt-6 text-white relative z-20">
                  <?php if ($slider_repeater[0]['title']) { ?>
                    <h3 class="text-[54px] text-white font-light leading-[1.1em] mb-4"><?php echo $slider_repeater[0]['title'] ?></h3>
                  <?php } ?>
                  <?php if ($slider_repeater[0]['description']) { ?>
                    <div class="prose max-w-none text-white text-lg mb-8"><?php echo $slider_repeater[0]['description'] ?></div>
                  <?php } ?>
                  <?php
      ...
      <div class="swiper slider_two_columns">
        <div class="swiper-wrapper bg-fiap-teal">
          <?php foreach ($slider_repeater as $slide) : ?>
            <div class="swiper-slide relative bg-fiap-teal h-[700px] overflow-hidden">
              <div class="absolute inset-0">
                <div class="flex h-full">
                  <div class="w-1/2 ml-auto"><img class="object-cover h-full w-full" src="<?php echo $slide['image']['url'] ?>"></div>
                </div>
              </div>
              <div class="container mx-auto py-32">
                <div class="flex items-center h-full">
        ...
        <div class="slider-buttons absolute bottom-10 left-0 right-0 z-10">
          <div class="container mx-auto">
            <div class="w-1/2 flex justify-end gap-x-4 pr-16">
              <button type="button" class="slider--button-prev w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-fiap-darkblue text-gray-500 hover:text-white transition-all duration-200">
              ...
              <button type="button" class="slider--button-next w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-fiap-darkblue text-gray-500 hover:text-white transition-all duration-200">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
